...
onAuthStateChanged(auth, user => {
    if (user) {
        ...
        fetchSalesHistory(userId); // Fetch sales history once the user is authenticated
    } else {
        // Optionally, handle user not logged in or perform anonymous login
        console.log("User is not logged in. Attempting anonymous login.");
