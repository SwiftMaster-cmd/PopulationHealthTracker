document.addEventListener('DOMContentLoaded', function() {
    ...
            if (!customerInfo) {
                return '<div class="customer-info-container"><h4>No Customer Information Available</h4></div>';
            }
    ...
                        <div class="customer-field"><strong>State ID:</strong> ${customerInfo.stateId || 'N/A'}</div>
                    </div>
                </div>
            `;
        }
