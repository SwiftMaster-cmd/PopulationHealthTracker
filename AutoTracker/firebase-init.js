...
<html>
<head>
    <title>Setup Auto Tracker</title>
...
<body>
    <div class="container">
        <div class="setup-container">
            <h2>Welcome to Auto Tracker!</h2>
            <div class="form-group">
                <h3>Set Up Your Auto Tracker</h3>
                <p>1. Click the button below to copy the bookmarklet script.</p>
                <p>2. Create a new bookmark in your browser.</p>
                <p>3. Paste the copied script into the URL field of the bookmark.</p>
                <p>4. Name the bookmark whatever you like and save it to your bookmarks bar.</p>
                <p>5. Click the bookmark each time an action is made to activate the tracker.</p>
                <p>The tracker active indicator will inform you that the sale will be tracked.</p>
                <button id="copyBookmarkletButton">Click me to copy AutoTracker Bookmark Script</button>
                <br><br>
                <button id="dashboardButton">Ready to go to the dashboard? Click me!</button>
                <br><br>
                <button id="helpButton">Having trouble? Click me, I'll send a report for you!</button>
            </div>
        </div>
    </div>
    <script>
